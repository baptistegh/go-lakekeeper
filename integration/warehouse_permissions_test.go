...
func TestPermissions_Warehouse_GetAuthzProps(t *testing.T) {
	...
	resp, r, err := client.PermissionV1().WarehousePermission(project).GetAuthzProperties(wh, nil)
...
func TestPermissions_Warehouse_SetManagedAccess(t *testing.T) {
	...
	r, err = client.PermissionV1().WarehousePermission(project).SetManagedAccess(wh, &permissionv1.SetWarehouseManagedAccessOptions{
		ManagedAccess: true,
	})
	assert.NoError(t, err)
	assert.NotNil(t, resp)
...
func TestPermissions_Warehouse_GetAccess(t *testing.T) {
	...
	resp, r, err := client.PermissionV1().WarehousePermission(project).GetAccess(wh, nil)
	assert.NoError(t, err)
	assert.NotNil(t, resp)
	assert.Equal(t, http.StatusOK, r.StatusCode)
...
func TestPermissions_Warehouse_GetAssignments(t *testing.T) {
	...
	resp, r, err := client.PermissionV1().WarehousePermission(project).GetAssignments(wh, nil)
	assert.NoError(t, err)
	assert.NotNil(t, resp)
	assert.Equal(t, http.StatusOK, r.StatusCode)
...
func TestPermissions_Warehouse_Update(t *testing.T) {
	...
	resp, _, err := client.PermissionV1().WarehousePermission(project).GetAssignments(wh, nil)
	assert.NoError(t, err)
	assert.NotNil(t, resp)
	...
	// adding permission
	r, err := client.PermissionV1().WarehousePermission(project).Update(wh, &permissionv1.UpdateWarehousePermissionsOptions{
...
func TestPermissions_Warehouse_SameAdd(t *testing.T) {
	...
	// adding permission
	r, err := client.PermissionV1().WarehousePermission(project).Update(wh, opt)
