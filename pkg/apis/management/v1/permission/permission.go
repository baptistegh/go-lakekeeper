...
type (
	PermissionServiceInterface interface {
		ServerPermissions() ServerPermissionsInterface
	}
...
func (s *PermissionService) ServerPermissions() ServerPermissionsInterface {
	return NewServerPermissionsService(s.client)
}
