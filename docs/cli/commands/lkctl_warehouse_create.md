## lkctl warehouse create

Create a new warehouse

```
lkctl warehouse create WAREHOUSENAME -f JSONCONFIGFILE [flags]
```

### Examples

```
  # Create a warehouse from file
...
```
  -f, --file string   Warehouse config file. JSON file or '-' for stdin
