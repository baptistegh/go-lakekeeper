## lkctl server bootstrap

Bootstraps the server with the current user

```
lkctl server bootstrap [flags]
```

### Examples

```
  # Bootstrap the server and get the server admin role
...
```
      --accept-terms-of-use   Accept the terms of use
      --as-operator           Bootstrap the server as an operator
